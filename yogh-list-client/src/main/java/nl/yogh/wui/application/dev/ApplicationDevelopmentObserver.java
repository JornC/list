package nl.yogh.wui.application.dev;
...
public class ApplicationDevelopmentObserver extends BasicEventComponent implements DevelopmentObserver {
  interface DevelopmentObserverMonitorImplEventBinder extends EventBinder<ApplicationDevelopmentObserver> {}
  ...
  @Inject
  public ApplicationDevelopmentObserver() {}
