...
tmux kill-session -t list-serve && { echo "Waiting for existing session to close"; sleep 2; }
...
echo "Launching tmux session 'list-serve'"
tmux new-session -d -s list-serve ./codeserver.sh
